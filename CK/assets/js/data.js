/* Novalyte client-safe seed catalogs.
   Provider rates are intentionally excluded from this public file.
   Client rates remain editable by the admin and are mirrored through the public dataset. */
window.NOVALYTE_SEED_SERVICES = [
  {
    ...
    clientRate: 320.00, rateUnit: 1000, min: 100, max: 10000000,
  ...
  },
  {
    ...
    clientRate: 320.00, rateUnit: 1000, min: 100, max: 100000,
  ...
  },
  {
    ...
    clientRate: 550.00, rateUnit: 1000, min: 100, max: 10000000,
  ...
  },
  {
    ...
    clientRate: 500.00, rateUnit: 1000, min: 100, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 4800.00, rateUnit: 1000, min: 50, max: 10000,
  ...
  },
  {
    ...
    clientRate: 190.00, rateUnit: 1000, min: 100, max: 1000000000,
...

  {
    ...
    clientRate: 5.00, rateUnit: 1000, min: 100, max: 2147482677,
  ...
  },
  {
    ...
    clientRate: 7.00, rateUnit: 1000, min: 100, max: 2147483647,
  ...
  },
  {
    ...
    clientRate: 6.00, rateUnit: 1000, min: 100, max: 2147482677,
  ...
  },
  {
    ...
    clientRate: 10.00, rateUnit: 1000, min: 10, max: 2147483647,
  ...
  },
  {
    ...
    clientRate: 18.00, rateUnit: 1000, min: 50, max: 2147483647,
  ...
  },
  {
    ...
    clientRate: 23.00, rateUnit: 1000, min: 50, max: 2147483647,
  ...
  },
  {
    ...
    clientRate: 28.00, rateUnit: 1000, min: 50, max: 2147483647,
  ...
  },
  {
    ...
    clientRate: 18.00, rateUnit: 1000, min: 10, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 38.00, rateUnit: 1000, min: 10, max: 5000000,
  ...
  },
  {
    ...
    clientRate: 22.00, rateUnit: 1000, min: 10, max: 100000,
  ...
  },
  {
    ...
    clientRate: 150.00, rateUnit: 1000, min: 50, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 205.00, rateUnit: 1000, min: 50, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 90.00, rateUnit: 1000, min: 100, max: 1000000,
...

  {
    ...
    clientRate: 42.00, rateUnit: 1000, min: 100, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 15.00, rateUnit: 1000, min: 10, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 5.00, rateUnit: 1000, min: 100, max: 2147482764,
  ...
  },
  {
    ...
    clientRate: 5.00, rateUnit: 1000, min: 10, max: 50000,
  ...
  },
  {
    ...
    clientRate: 90.00, rateUnit: 1000, min: 50, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 130.00, rateUnit: 1000, min: 50, max: 1000000,
  ...
  },
  {
    ...
    clientRate: 90.00, rateUnit: 1000, min: 10, max: 100000,
...

  {
    ...
    clientRate: 105.56, rateUnit: 1000, min: 100, max: 1000000,
  ...
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 68.04, rateUnit: 1000, min: 50, max: 2147483647,
  ...
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 88.09, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views", visible: true
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 95.23, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views", visible: true
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 99.72, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views", visible: true
  },
  {
    ...
    clientRate: 4.65, rateUnit: 1000, min: 50, max: 500000,
  ...
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 9.30, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 18.60, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 27.91, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 37.21, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 55.81, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 74.42, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 111.63, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 223.26, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    description: "YouTube live stream views service from provider panel screenshot.",
    clientRate: 446.52, rateUnit: 1000, min: 50, max: 500000,
    avgTime: "Not enough data", tag: "Live Stream Views", visible: true
  },
  {
    ...
    clientRate: 3099.94, rateUnit: 1000, min: 100, max: 100000,
  ...
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 3630.56, rateUnit: 1000, min: 100, max: 100000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 4461.78, rateUnit: 1000, min: 100, max: 10000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 2578.56, rateUnit: 1000, min: 100, max: 10000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 1528.38, rateUnit: 1000, min: 10, max: 10000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 1438.92, rateUnit: 1000, min: 50, max: 10000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 1498.95, rateUnit: 1000, min: 100, max: 50000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 1892.19, rateUnit: 1000, min: 50, max: 10000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 1210.95, rateUnit: 1000, min: 5, max: 1000000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube subscribers service from provider panel screenshot.",
    clientRate: 1951.44, rateUnit: 1000, min: 100, max: 400000,
    avgTime: "Not enough data", tag: "Subscribers", visible: true
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 56.39, rateUnit: 1000, min: 100, max: 10000000,
  ...
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 61.80, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views High Speed", visible: true
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 66.37, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views High Speed", visible: true
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 70.95, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views High Speed", visible: true
  },
  {
    ...
    description: "YouTube views service from provider panel screenshot.",
    clientRate: 75.53, rateUnit: 1000, min: 100, max: 10000000,
    avgTime: "Not enough data", tag: "Video/Shorts Views High Speed", visible: true
  },
  {
    ...
    clientRate: 133.45, rateUnit: 1000, min: 100, max: 100000,
  ...
  },
  {
    ...
    description: "YouTube likes service from provider panel screenshot.",
    clientRate: 106.21, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Likes", visible: true
  },
  {
    ...
    description: "YouTube likes service from provider panel screenshot.",
    clientRate: 147.25, rateUnit: 1000, min: 100, max: 100000,
    avgTime: "Not enough data", tag: "Likes", visible: true
  },
  {
    ...
    description: "YouTube likes service from provider panel screenshot.",
    clientRate: 151.86, rateUnit: 1000, min: 100, max: 100000,
    avgTime: "Not enough data", tag: "Likes", visible: true
  },
  {
    ...
    description: "YouTube likes service from provider panel screenshot.",
    clientRate: 555.56, rateUnit: 1000, min: 10, max: 100000,
  ...
  },
  {
    ...
    description: "YouTube likes service from provider panel screenshot.",
    clientRate: 88.04, rateUnit: 1000, min: 10, max: 20000,
    avgTime: "Not enough data", tag: "Comment Likes", visible: true
  },
  {
    ...
    description: "YouTube likes service from provider panel screenshot.",
    clientRate: 273.10, rateUnit: 1000, min: 50, max: 50000,
    avgTime: "Not enough data", tag: "Likes", visible: true
  },
  {
    ...
    clientRate: 308.64, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    description: "YouTube comments service from provider panel screenshot.",
    clientRate: 23.07, rateUnit: 1000, min: 10, max: 10000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    description: "YouTube comments service from provider panel screenshot.",
    clientRate: 96.88, rateUnit: 1000, min: 5, max: 5000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    description: "YouTube comments service from provider panel screenshot.",
    clientRate: 284.02, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    description: "YouTube comments service from provider panel screenshot.",
    clientRate: 96.97, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    description: "YouTube comments service from provider panel screenshot.",
    clientRate: 546.20, rateUnit: 1000, min: 1, max: 10000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    clientRate: 60.32, rateUnit: 1000, min: 10, max: 100000,
  ...
  },
  {
    ...
    description: "Telegram members - non drop service from provider panel screenshot.",
    clientRate: 59.8, rateUnit: 1000, min: 10, max: 50000,
  ...
  },
  {
    ...
    clientRate: 0.6853, rateUnit: 1000, min: 1, max: 100000,
  ...
  },
  {
    ...
    name: "Telegram Members (Channel/Group) [Max 100K] | Superinstant | Cancel Enable | No Refill | Day 100K",
    description: "Telegram members - cheapest service from provider panel screenshot.",
    clientRate: 1.24, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Members - Cheapest", visible: true
  },
  {
    ...
    description: "Telegram members - cheapest service from provider panel screenshot.",
    clientRate: 1.51, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Members - Cheapest", visible: true
  },
  {
    ...
    description: "Telegram members - cheapest service from provider panel screenshot.",
    clientRate: 2.06, rateUnit: 1000, min: 10, max: 100000,
    avgTime: "Not enough data", tag: "Members - Cheapest", visible: true
  },
  {
    ...
    clientRate: 66.35, rateUnit: 1000, min: 10, max: 100000,
  ...
  },
  {
    ...
    description: "Telegram members - recommended service from provider panel screenshot.",
    clientRate: 69.55, rateUnit: 1000, min: 10, max: 50000,
  ...
  },
  {
    ...
    description: "Telegram members - recommended service from provider panel screenshot.",
    clientRate: 71.32, rateUnit: 1000, min: 10, max: 50000,
    avgTime: "Not enough data", tag: "Members - Recommended", visible: true
  },
  {
    ...
    description: "Telegram members - recommended service from provider panel screenshot.",
    clientRate: 90.48, rateUnit: 1000, min: 10, max: 50000,
    avgTime: "Not enough data", tag: "Members - Recommended", visible: true
  },
  {
    ...
    description: "Telegram members - recommended service from provider panel screenshot.",
    clientRate: 95.5, rateUnit: 1000, min: 10, max: 50000,
    avgTime: "Not enough data", tag: "Members - Recommended", visible: true
  },
  {
    ...
    description: "Telegram members - recommended service from provider panel screenshot.",
    clientRate: 6.24, rateUnit: 1000, min: 10, max: 80000,
  ...
  },
  {
    ...
    clientRate: 0.1355, rateUnit: 1000, min: 10, max: 2147483647,
  ...
  },
  {
    ...
    description: "Telegram post views service from provider panel screenshot.",
    clientRate: 0.6145, rateUnit: 1000, min: 10, max: 2147483647,
  ...
  },
  {
    ...
    description: "Telegram post views service from provider panel screenshot.",
    clientRate: 1.24, rateUnit: 1000, min: 10, max: 2147483647,
  ...
  },
  {
    ...
    description: "Telegram post views service from provider panel screenshot.",
    clientRate: 2.47, rateUnit: 1000, min: 10, max: 2147483647,
    avgTime: "Not enough data", tag: "Post Views", visible: true
  },
  {
    ...
    description: "Telegram post views service from provider panel screenshot.",
    clientRate: 3.7, rateUnit: 1000, min: 10, max: 2147483647,
    avgTime: "Not enough data", tag: "Post Views", visible: true
  },
  {
    ...
    description: "Telegram post views service from provider panel screenshot.",
    clientRate: 6.17, rateUnit: 1000, min: 10, max: 2147483647,
    avgTime: "Not enough data", tag: "Post Views", visible: true
  },
  {
    ...
    description: "Telegram post views service from provider panel screenshot.",
    clientRate: 24.67, rateUnit: 1000, min: 10, max: 2147483647,
    avgTime: "Not enough data", tag: "Post Views", visible: true
  },
  {
    ...
    clientRate: 0.9048, rateUnit: 1000, min: 10, max: 1000000,
  ...
  },
  {
    ...
    description: "Telegram reactions service from provider panel screenshot.",
    clientRate: 2.31, rateUnit: 1000, min: 1, max: 50000,
    avgTime: "Not enough data", tag: "Reactions", visible: true
  },
  {
  ...
  },
  {
    ...
    description: "Telegram reactions service from provider panel screenshot.",
    clientRate: 1.91, rateUnit: 1000, min: 1, max: 50000,
    avgTime: "Not enough data", tag: "Reactions", visible: true
  },
  {
  ...
  },
  {
    ...
    clientRate: 22.69, rateUnit: 1000, min: 1, max: 50000,
  ...
  },
  {
    ...
    description: "Telegram votes service from provider panel screenshot.",
    clientRate: 30.04, rateUnit: 1000, min: 10, max: 300000,
    avgTime: "Not enough data", tag: "Votes", visible: true
  },
  {
    ...
    clientRate: 173.56, rateUnit: 1000, min: 10, max: 5000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
    ...
    description: "Telegram comments service from provider panel screenshot.",
    clientRate: 173.56, rateUnit: 1000, min: 10, max: 500000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
  ...
  },
  {
    ...
    description: "Telegram comments service from provider panel screenshot.",
    clientRate: 176.63, rateUnit: 1000, min: 10, max: 10000,
    avgTime: "Not enough data", tag: "Comments", visible: true
  },
  {
...
window.NOVALYTE_DIGITAL_PRODUCTS = [
  {
    "id": "dp_disney_plus",
    "name": "Disney+",
    "price": 70,
    ...
    "category": "Streaming",
    "description": "Enjoy Disney, Marvel, Star Wars, Pixar, and National Geographic content in one subscription. Great for family and franchise fans. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_canva_pro",
    "name": "Canva Pro",
    ...
    "description": "Create professional designs, presentations, social media posts, and marketing materials with premium tools and assets. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_hbo_max",
    "name": "HBO Max",
    ...
    "image": "hbo-max.png",
    "category": "Streaming",
    "description": "Stream blockbuster movies, HBO Originals, DC content, and exclusive series. Ideal for premium entertainment lovers. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_loklok",
    "name": "Loklok",
    ...
    "image": "loklok.png",
    "category": "Streaming",
    "description": "Access Asian dramas, movies, anime, and trending entertainment content. Perfect for binge-watchers. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_bilibili",
    "name": "Bilibili",
    ...
    "description": "Watch anime, gaming videos, variety shows, and exclusive Asian content with premium features. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_prime_video",
    "name": "Prime Video",
    ...
    "category": "Streaming",
    "description": "Enjoy Amazon Originals, movies, TV series, and exclusive content across multiple genres. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_vivaone",
    "name": "VivaOne",
    ...
    "image": "vivaone.png",
    "category": "Streaming",
    "description": "Stream Filipino movies, TV shows, concerts, and exclusive local entertainment. Best for fans of Filipino content. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_iwanttfc",
    "name": "iWantTFC",
    ...
    "image": "iwanttfc.png",
    "category": "Streaming",
    "description": "Watch ABS-CBN shows, Filipino dramas, movies, and live content wherever you are. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_iqiyi",
    "name": "iQIYI",
    ...
    "image": "iqiyi.png",
    "category": "Streaming",
    "description": "Watch popular Asian dramas, anime, and exclusive originals with premium streaming benefits. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_spotify",
    "name": "Spotify",
    ...
    "image": "spotify.png",
    "category": "Music",
    "description": "Listen to millions of songs without ads, enjoy unlimited skips, and download music for offline listening. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_capcut_pro",
    "name": "CapCut Pro",
    ...
    "description": "Edit videos with premium templates, advanced effects, and creator tools for social media content. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_grammarly",
    "name": "Grammarly Premium",
    "price": 66,
    "image": "grammarly-premium.png",
    "category": "Student Tools",
    "description": "Improve grammar, spelling, tone, and writing clarity with advanced writing assistance for school, work, and business. Delivered via email."
  },
  {
    "id": "dp_chatgpt",
    "name": "ChatGPT",
    ...
    "image": "chatgpt.png",
    "category": "AI Tools",
    "description": "Get access to advanced AI assistance for writing, studying, brainstorming, coding, research, productivity, and everyday tasks. Delivered via email."
  },
  {
    "id": "dp_quillbot",
    "name": "Quillbot",
    ...
    "image": "quillbot.png",
    "category": "Student Tools",
    "description": "Paraphrase, rewrite, summarize, and enhance your writing with AI-powered tools for students, professionals, and content creators. Delivered via email."
  },
  {
    "id": "dp_youtube_premium",
    "name": "YouTube Premium",
    "price": 85,
    "image": "youtube-premium.png",
    "category": "Streaming",
    "description": "Enjoy ad-free videos, background play, and offline downloads for uninterrupted viewing and listening. 1 Month Access. Delivered via email."
  },
  {
    "id": "dp_netflix",
    "name": "Netflix",
    ...
    "image": "netflix.png",
    "category": "Streaming",
    "description": "Watch thousands of movies, series, documentaries, and Netflix Originals in high quality. Perfect for entertainment anytime, anywhere. 1 Month Access. Delivered via email."
  }
];
